...
@section('content')
    ...
    <section>
        {{-- Hero Section --}}
        <section class="min-w-[412px]">
            <div class="relative p-6 text-white overflow-hidden w-full h-screen">
                <img src="{{ secure_asset('image/omsetin/Rectangle1.png') }}" alt="bg-blue"
                    class="absolute top-0 left-0 w-full h-full object-cover -z-10" />
                <!-- Background image -->
                <img src="{{ secure_asset('image/omsetin/phone-mockup.png') }}" alt="phone-mockup"
                    class="mx-auto top-0 left-0 w-[200px] h-[350px] mb-10" />
                <!-- Konten text -->
                <div class="max-w-md z-10 relative">
                    <img src="{{ secure_asset('image/omsetin/omsetin.png') }}" alt="logo-aplikasi" class="w-64 mb-12" />
                    <p class="mt-4 text-sm">
                        Lorem ipsum dolor sit amet consectetur. Ante suscipit
                        porta...
                    </p>
        ...
        <section class="py-20 bg-white">
            ...
            <div class="max-w-3xl mx-auto text-center mb-16 py-5 scroll-reveal-section">
                <p class="text-lg uppercase text-[#04b2f7] font-semibold tracking-wider">
                    {{ __('message.home.services.title') }}</p>
            ...
            <div class="container mx-auto px-4 lg:px-8 space-y-24">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-12 scroll-reveal-row">
                    ...
                    <div class="lg:w-1/2 w-full space-y-6">
                        <h3 class="text-3xl font-bold text-gray-800">{{ __('message.home.services.items.development') }}
                        </h3>
                        ...
                        <div class="pt-2">
                            <a href="{{ route('services') }}"
                                class="inline-flex items-center group text-[#04b2f7] font-semibold text-lg">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-12 scroll-reveal-row">
                    ...
                    <div class="lg:w-1/2 w-full space-y-6">
                        <h3 class="text-3xl font-bold text-gray-800">{{ __('message.home.services.items.it_support') }}
                        </h3>
                        <p class="text-gray-600 text-lg leading-relaxed">
